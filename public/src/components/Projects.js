            ...
            <div className="codenames project">
                ...
                <div className="project__body">
                    <div className="project__inner">
                        ...
                        <p>Multiplayer card game for four players, with live updates using websockets. Built with Node, Socket.io, and Bootstrap.</p>
            ...
            <div className="danielamsel project">
                ...
                <div className="project__body">
                    <div className="project__inner">
                        ...
                        <p>Built with Express, Node, and React for tight response, controlled animation, and fast loading.</p>
                    </div>
                </div>
            </div>
